...
questions = {
    1: {'qst': 'Как записаться на первую тренировку?', 'answer': 'Пройдите регистрацию, это автоматически запишет вас на первую тренировку. Приходите в подходящую вам группу(расписание смотрите в этом же приложении)'},
    ...
    5: {'qst': 'Какие группы есть?', 'answer': 'Детская, взрослая и группа здоровья.'},
